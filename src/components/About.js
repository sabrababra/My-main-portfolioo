            ...
            <div className="card rounded-none lg:card-side bg-black shadow-xl">
                ...
                <div className="card-body p-10">
                    ...
                    <p className='text-lg text-gray-400'>
                        I'm Sabrina Yesmin Prome.
                        <br />
                        My Email : sabrinayesminprome@gmail.com
                        <br />
                        Address: Rajshahi, Bangladesh
                        <br />
                        <div className='py-5 flex flex-row gap-4'>
                            <a target='_blank' href="https://www.linkedin.com/in/sabrina-yesmin-prome/" rel="noreferrer">
                            ...
                            <a target='_blank' href="https://github.com/sabrababra" rel="noreferrer">
